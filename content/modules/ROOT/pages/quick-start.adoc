...
| 1
| Operators - `oc apply -k 01-prerequisites/operators/`, wait for CSVs
| 2-5 min
...
| 3
| RHOAI - DSC with modelsAsService: Managed, Dashboard flags
| 3-5 min

| 4
| MaaS - PostgreSQL secrets/deployment, Authorino TLS, wait for maas-api
| 3-5 min
...
| Phase 6 only - wrapper for `06-verification/verify.sh`
|===
